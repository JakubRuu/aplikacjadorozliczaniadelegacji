...
class AppInitializer {
    ...
    void init(){
        ...
        Field field1= new Field("LegiaCentral1","Legia1","Jaga1",1,"1", person1);
        Field field2 = new Field("LegiaCentral2","Legia2","Jaga2",2,"3", person1);
        Field field3 = new Field("LegiaCentral3","Legia3","Jaga3",3,"4", person1);

        Field field4 = new Field("LegiaCentral3","Legia4","Jaga4",3,"42", person2);
        Field field5 = new Field("LegiaCentral2","Legia5","Jaga5",1,"41", person2);
        Field field6 = new Field("LegiaCentral1","Legia6","Jaga6",4,"4", person2);

        Field field7 = new Field("LegiaCentral3","Legia7","Jaga7",5,"45", person3);
        Field field8 = new Field("LegiaCentral2","Legia8","Jaga8",6,"45", person3);
        Field field9 = new Field("LegiaCentral1","Legia9","Jaga9",2,"45", person3);
