...
class FieldUpdater {
    ...
    Field update(String id, Field field) {
        ...
        updateNameOfObject(fieldToUpdate, field);
        ...
        updatePerson(fieldToUpdate, field);
        checkIfFieldIsUnique(fieldToUpdate);
        return fieldRepository.save(fieldToUpdate);

    }

    private void checkIfFieldIsUnique(Field fieldToUpdate) {
    ...
    private void updateNameOfObject(Field fieldToUpdate, Field field) {
    ...
    private void updatePerson(Field fieldToUpdate, Field field) {
        ...
        if (person != null) {
            ...
            fieldToUpdate.setPerson(person);
        }
    }
}
